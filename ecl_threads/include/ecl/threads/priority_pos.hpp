 ...
 */
bool ECL_PUBLIC set_priority(Priority priority_level) ecl_throw_decl(StandardException);
/**
 ...
 */
Priority ECL_PUBLIC get_priority() ecl_throw_decl(StandardException);
 ...
 */
std::string ECL_PUBLIC print_priority_diagnostics() ecl_throw_decl(StandardException);
 ...
 */
bool ECL_LOCAL set_real_time_priority(int policy,int priority_level) ecl_throw_decl(StandardException);
